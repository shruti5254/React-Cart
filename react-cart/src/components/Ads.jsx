            ...
            <div className="custom-container w-full h-max mx-auto py-8">
                <div className="flex flex-col md:flex-row gap-4 md:gap-14 items-center justify-between">
                    <div className="w-full md:w-1/2 flex flex-col item-start justify-start py-4">
                        <Titles titleSmall="Categories" titleLarge="Enhance Your Music Experience" spanClassName="text-lime-400 before:!bg-lime-400" headingClassName="!text-white tracking-wide py-2 md:pt-4 leading-[45px]"/>
                        ...
                        <MyButton className ="!bg-lime-500 mt-6 mb-2" label="Buy Now !"/>
                    </div>
