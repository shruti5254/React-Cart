...
const Hero = () => {
  return (
    <div className="section w-[75%] relative bg-customblack h-max">
      <div className="custom-container w-full h-full flex flex-row items-center justify-between gap-10 py-8">
        ...
        <div className="hero-section w-full lg:w-1/2 h-[350px]  rounded-full bg-radial from-zinc-500 from-15% to-[#111827] to-50%">
