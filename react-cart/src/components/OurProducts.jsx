            ...
            <div className="custom-container mx-auto w-full mt-[30px] mb-[30px]">
                ...
                <div className="products-wrapper mt-[30px] w-full mx-auto">
                    <div className="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mb-4 mx-auto">
                        <Cards title="wired Keyboard" image={Headphone} hoverActionLink="/cart" hoverText="add to cart" tagLeft="-30%" showHeart={true} showEye={true} priceNew="$400" priceOld="$600"></Cards>
                        ...
                        <Cards title="wired Keyboard" image={Headphone} hoverActionLink="/cart" hoverText="add to cart" tagLeft="-60%" showHeart={true} showEye={true} priceNew="$4000" priceOld="$6000"></Cards>
                        ...
                        <Cards title="wired Keyboard" image={Headphone} hoverActionLink="/cart" hoverText="add to cart" tagLeft="New" showHeart={true} showEye={true} priceNew="$800" priceOld="$900"></Cards>
                        ...
                        <Cards title="wired Keyboard" image={Headphone} hoverActionLink="/cart" hoverText="add to cart" tagLeft="-50%" showHeart={true} showEye={true} priceNew="$800" priceOld="$900"></Cards>
                        
                        <Cards title="wired Keyboard" image={Headphone} hoverActionLink="/cart" hoverText="add to cart" tagLeft="-35%" showHeart={true} showEye={true} priceNew="$800" priceOld="$900"></Cards>
